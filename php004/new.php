<?php
    ...
    if ($has_data) {
        $errors = checkout_employee($_POST['employee']);
...
<body>
    <div style="width: 1000px; margin: 0 auto; text-align: center">
        ...
        <form method="post">
            <div class="field">
                <label>ФИО</label>
                <input type="text" name="employee[name]" value="<?= $has_data ? $_POST['name'] : '' ?>" />
            ...
            <div class="field">
                ...
                <input type="text" name="employee[birth]" value="<?= $has_data ? $_POST['birth'] : '' ?>" />
            ...
            <div class="field">
                <label>Телефон</label>
                <input type="text" name="employee[phone]" value="<?= $has_data ? $_POST['phone'] : '' ?>"/>
            ...
            <div class="field">
                ...
                <input type="text" name="employee[post]" value="<?= $has_data ? $_POST['post'] : '' ?>" />
